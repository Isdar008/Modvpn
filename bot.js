// ================================
// 🚀 Telegram GitHub Bot (Auto Payment QRIS + Auto Expired 5 Menit)
// ================================
...
// ======== Konfigurasi =========
dotenv.config({ path: "/root/botenv/.env" });
...
bot.on("callback_query", async (query) => {
  ...
  // === Pilih durasi registrasi IP ===
    ...
    const basePrice = days === 30 ? 10 : 18000;
    ...
    try {
      ...
      if (get.status !== "success") throw new Error(JSON.stringify(get));
